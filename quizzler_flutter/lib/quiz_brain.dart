 ...
 int _questionNumber=0;
  List<Question> _quzstionBank=[
   ...
   String getQuestionText(){
     return _quzstionBank[_questionNumber].questionText;
   }
void nextQuestion(){
     if (_questionNumber < _quzstionBank.length-1){
       _questionNumber++;

     }
}
bool getQuestionAnswer(){
     return _quzstionBank[_questionNumber].questionAnswer;
}
bool isFinished(){
     if (_questionNumber >= _quzstionBank.length-1){
       return true;
